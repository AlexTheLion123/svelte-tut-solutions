...
(function () {
    ...
    /* src/components/Tile.svelte generated by Svelte v3.42.6 */

    const file$3 = "src/components/Tile.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "tile svelte-rjw8pn");
    			set_style(div, "background", /*background*/ ctx[0]);
    			add_location(div, file$3, 9, 0, 183);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div, "click", /*randomColor*/ ctx[1], false, false, false);
    				mounted = true;
    			}
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ background, randomColor });
    ...
    class Tile extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { background: 0 });
    		...
    		if (/*background*/ ctx[0] === undefined && !('background' in props)) {
    			console.warn("<Tile> was created without expected prop 'background'");
    		}
    	}
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button0.textContent = "Remove previous";
    			t1 = space();
    			button1 = element("button");
    			button1.textContent = "clear";
    			add_location(button0, file$2, 14, 4, 242);
    			add_location(button1, file$2, 15, 4, 301);
    			attr_dev(div, "class", "buttons svelte-thhu7o");
    			add_location(div, file$2, 13, 0, 216);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*removePrev*/ ctx[1], false, false, false),
    					listen_dev(button1, "click", /*clear*/ ctx[0], false, false, false)
    				];
    ...
    /* src/components/Board.svelte generated by Svelte v3.42.6 */
    ...
    // (16:8) {#each Array(100) as _, i}
    function create_each_block(ctx) {
    	let tile;
    	let current;

    	tile = new Tile({
    			props: { background: /*background*/ ctx[0] },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const tile_changes = {};
    			if (dirty & /*background*/ 1) tile_changes.background = /*background*/ ctx[0];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(16:8) {#each Array(100) as _, i}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "board svelte-1ii66p6");
    			add_location(div0, file$1, 14, 4, 292);
    			attr_dev(div1, "class", "container");
    			add_location(div1, file$1, 12, 0, 233);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const clear = () => {
    		...
    		$$invalidate(0, background = 'rgb(46, 46, 46)');
    	};
    	...
    	$$self.$capture_state = () => ({ Tile, Button, background, clear });
